    ...
    return (
        <div className="flex h-screen bg-slate-50 font-sans antialiased overflow-hidden">
            ...
            `}>
                ...
                <div className="h-16 flex items-center px-5 border-b border-slate-100 flex-shrink-0 overflow-hidden">
                    <div className="flex items-center gap-3 w-full">
                        ...
                        <div className={`flex flex-col whitespace-nowrap transition-all duration-300 ${isSidebarCollapsed ? 'opacity-0 w-0' : 'opacity-100 w-auto'}`}>
                ...
                <div className="flex-1 overflow-y-auto overflow-x-hidden sidebar-scroll p-4 space-y-6">
                    {menuGroups.map((group, index) => (
                        <div key={index}>
                            <h3 className={`px-3 text-[11px] font-bold text-slate-400 uppercase tracking-wider mb-2 transition-all duration-300 whitespace-nowrap ${isSidebarCollapsed ? 'opacity-0 h-0 overflow-hidden mb-0' : 'opacity-100'}`}>
                                {group.title}
                            </h3>
